  ...
  do while(.not.quit) 
     ...
     if(do_montecarlo_therm) then
        ...
        do iterstr=0,rt_mcparams%niter_vstruct
           ...
           !$ write(stdo,*) 'Number of threads used: ', setthreads
           !$ write(stdo,*) '...'
...
subroutine write_banner()
  ...
  write(stdo,*) '                                                                '
  write(stdo,*) '       This is the 3-D reincarnation of the 2-D RADMC code      '
  write(stdo,*) '               (c) 2010/2015 Cornelis Dullemond                 '
  write(stdo,*) '                                                                '
  write(stdo,*) '************* NOTE: THIS IS STILL A BETA VERSION ***************'
  write(stdo,*) '****** Some modes/capabilities are not yet ready/mature ********'
  write(stdo,*) '                                                                '
